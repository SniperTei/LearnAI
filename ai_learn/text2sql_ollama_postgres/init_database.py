"""
PostgreSQL Database Initialization Script for Ollama version
...
def insert_sample_data():
    ...
    products_data = [
        ...
        ('Basic Auto Insurance', 'Auto', 50.00, 150.00, 50000.00, 1000.00, '2023-01-01'),
...
if __name__ == "__main__":
    print("Initializing PostgreSQL database with Ollama...")
    create_tables()
    insert_sample_data()
