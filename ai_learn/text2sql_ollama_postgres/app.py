"""
Ollama PostgreSQL Text2SQL Streamlit Demo App
A friendly web interface to query PostgreSQL database with natural language using Ollama
"""
...
# Page configuration
st.set_page_config(
    page_title="Ollama PostgreSQL Text2SQL Assistant",
    page_icon="🤖",
    layout="wide"
)
...
def main():
    ...
    # Title
    st.markdown('<h1 class="main-header">🤖 Ollama PostgreSQL Text2SQL Assistant</h1>', unsafe_allow_html=True)
